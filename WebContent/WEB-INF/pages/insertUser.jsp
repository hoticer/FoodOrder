		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="top-navbar-collapse">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a
						href="bossServlet?method=userManager"> <span
	...
	<div class="container" id="all">
		...
		<c:if test="${requestScope.success!=null }">
			<div
				...
				<a href="bossServlet?method=userManager" class="btn btn-info">返回查看</a>
			</div>
		</c:if>
		<div class="row col-xs-10 col-xs-offset-1">
			<br>
			<form class="form-horizontal" role="form"
				action="bossServlet?method=insertUser&userId=${requestScope.user.userId }"
				method="post">
				...
				<div class="form-group">
					...
					<div class="col-sm-10 input-group">
						...
						<select class="form-control" id="access" name="access" role="1">
				...
				<div class="form-group" id="fuze" hidden="true">
					<label for="price" class="col-sm-2 control-label">负责</label>
					<div class="col-sm-10 input-group">
						<div class="input-group-addon">
							<span class="glyphicon glyphicon-flag"></span>
						</div>
						<input type="text" class="form-control" id="access2"
							name="access2" value="1">
						<div class="input-group-addon">
							<span id="accessSpan">组: 1-4号桌</span>
						</div>
					</div>
				</div>
				<div class="form-group col-sm-push-2 col-sm-10">
					<div class="btn-group btn-group-justified">
						...
						<a href="bossServlet?method=userManager"

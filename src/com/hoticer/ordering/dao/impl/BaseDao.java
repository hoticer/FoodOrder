...
import com.hoticer.ordering.dao.Dao;
import com.hoticer.ordering.db.JDBCUtils;
import com.hoticer.ordering.utils.ReflectionUtils;
...
public class BaseDao<T> implements Dao<T> {
	...
	public <V> V getSingleVal(String sql, Object... args) {
		...
		try {
			connection = ConnectionContext.getInstance().get();
			return (V) queryRunner.query(connection, sql, new ScalarHandler<T>(), args);
		} catch (Exception e) {
			e.printStackTrace();
		} 
		return null;
